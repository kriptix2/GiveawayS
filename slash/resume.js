module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        client.giveawaysManager.unpause(giveaway.messageId)
            ...
            .then(() => {
                // Success message
                interaction.reply(`:white_check_mark: **[This giveaway](https://discord.com/channels/${giveaway.guildId}/${giveaway.channelId}/${giveaway.messageId})** has been successfully resumed!`);
            })
            .catch((e) => {
                interaction.reply({
                    content: e,
