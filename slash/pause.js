module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        client.giveawaysManager.pause(giveaway.messageId)
            ...
            .then(() => {
                // Success message
                interaction.reply(`:white_check_mark: **[This giveaway](https://discord.com/channels/${giveaway.guildId}/${giveaway.channelId}/${giveaway.messageId})** has now been paused!`);
            })
            .catch((e) => {
                interaction.reply({
                    content: e,
